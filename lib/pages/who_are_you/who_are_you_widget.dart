...
class WhoAreYouWidget extends StatefulWidget {
  const WhoAreYouWidget({super.key});

  static String routeName = 'WhoAreYou';
  static String routePath = '/whoAreYou';
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        300.0, 0.0, 0.0, 0.0),
                                    child: Text(
                                      'THIS WILL BE SHOWN TO OTHERS WHEN YOU APPEAR',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.oswald(
                            ...
                            child: Row(
                              ...
                              children: [
                                FlutterFlowRadioButton(
                                  options: FFAppState().AthleteOptions.toList(),
                          ...
                          if (_model.radioButtonValue == 'Athlete')
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 20.0, 0.0, 0.0),
                              child: Row(
